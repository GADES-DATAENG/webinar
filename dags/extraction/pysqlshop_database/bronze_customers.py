...
LOCAL_CSV_PATH = f"{Variable.get("LOCAL_FILE_PATH")}/olist_customers_dataset.csv"
PROJECT_ID = Variable.get("GCP_PROJECT_ID")
BRONZE_DATASET = Variable.get("BRONZE_BIGQUERY_DATASET")
BIGQUERY_TABLE = f"{PROJECT_ID}.{BRONZE_DATASET}.bronze_customers"
...
def generate_unique_file_name(**kwargs):
    ...
    unique_file_name = f"customers/data_{unique_id}_{timestamp}.csv"
...
with DAG(
    ...
    catchup=False,
    tags=["bigquery", "pysqlshop", "bronze_layer", "customers"],
) as dag:
